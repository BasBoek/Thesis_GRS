Write_SDM_Rasters <- function(myRespName, Output_Loc){
  ...
  Rasters <- list.files(paste("D:/SDM/SDM_Output/", genus_name, ".", species_name, "/proj_current", sep=""), pattern=".gri", full.names=T)
  Rasternames <- list.files(paste("D:/SDM/SDM_Output/", genus_name, ".", species_name, "/proj_current", sep=""), pattern=".gri")
