...
DataSpecies <- read.csv("~/Desktop/Nullmodel_Butter/Butter5k_1998_present_P4.csv")
head(DataSpecies)
summary(DataSpecies)
...
sp.names <- c("Piernapi", "Pierrapa", "Paraaege", "Vaneatal" ,"Polyicar", "Pyrotith", "Aglaurti", "Pierbras", "Inacio",   "Vanecard", "Plebages", "Celaargi"
,"Thymline", "Manijurt", "Arasleva" ,"Papimach", "Lasimege" ,"Thymsylv", "Polyc.al", "Lycaphla", "Gonerham", "Neozquer", "Colicroc", "Anthcard", "Hippseme", "Coenpamp", "Aphahype"
, "Nympanti", "Ochlfaun", "Issolath", "Colihyal", "Cacymars", "Lampboet", "Argypaph", "Nymppoly", "Limecami", "Satyilic", "Leptsina", "Argyniob", "Callrubi", "Cupimini", "Plebargu"
, "Cartpala", "Argyadip", "Hespcomm", "Pyrgmalv", "Lycatity", "Iphipoda", "Eryntage", "Pontdapl", "Thecbetu", "Argyagla", "Lycadisp", "Macualco", "Bolosele", "Melagala", "Apatiris"
, "Hetemorp", "Macunaus", "Macutele", "Danaplex", "Polycori", "Satyw.al", "Polysemi", "Melicinx", "Carcalce", "Pyrgcirs", "Meliatha", "Brenino",  "Hippstat", "Aporcrat", "Lycavirg"
, "Coentull", "Boloaqui", "Plebopti", "Melididy")
...
MyBiomodSF <- function(sp.n){
  ...
  myRespCoord = DataSpecies[c('POINT_X','POINT_Y')]
  ...
  ### Make projections on current variable
  predictor.files_Complete <- list.files("~/Desktop/Nullmodel_Butter/p4_5k/complete_area", pattern='.asc$', full.names=T)
